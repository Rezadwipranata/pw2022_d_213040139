        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            ...
            <ul class="navbar-nav">
              ...
              if (isset($_SESSION['id'])) {
                if ($_SESSION['id'] == 1) {
                  echo "<li class='nav-item'> <a href='admin.php' class='nav-link'>Tambahkan Film</a> </li>";
                }
              }
              echo"<li class='nav-item'> <a href='account.php' class='nav-link'>Akun</a> </li>
              ...
              echo"<h1 style='color:black;position:sticky;'>SELAMAT DATANG </h1><b style = 'color: white;font-size: 25px'><i> ".ucwords($rel['name'])." !</i></b>
                  </div>
                  </header>
                  <section>
                ...
                <div class='row'>
                  <div class='col'>
                    ...
                    <h4 style='color:black;font-size:30px;'>Terakhir ditonton :
                  ...
                  <div class='col'>
                    <form action='search.php' method='POST'>
                      <select  name='option' style='padding:5px;'>
                        ...
                        <option value='rdate'>Tahun Rilis</option>
                      </select>
                      <input type='text' placeholder='Enter..' style='margin-left:10px;margin-top:10px;padding:5px;' name='textoption'>

                      <input type='submit' name='submit' class='btn btn-success' style='display:inline;width:100px;margin-left:20px;margin-right:20px;margin-top:5px;' value='Cari'/></h4>
                    </form>
                  </div>
                </div>
                </div>";
                  ?>
      <div class="jumbotron">
        <h2 style='margin-top:0px;padding-top:0px;'>Terakhir Ditambahkan</h2>
          <div class="row">
            <?php
