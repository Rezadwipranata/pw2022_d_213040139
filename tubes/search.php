    ...
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            ...
            <ul class="navbar-nav">
              ...
              echo"<h1 style='color:black;position:sticky;'>SELAMAT DATANG </h1><i style = 'color: white;font-size: 25px'> ".ucwords($rel['name'])." !</i>
                  </div>
                  </header>
                  <section>
                ...
                <div class='row'>
                  ...
                  <div class='col'>
                    <form action='search.php' method='POST'>
                      <select  name='option' style='padding:5px;'>
                        ...
                        <option value='3'>Tahun Rilis</option>
                      </select>
                  ...
                  ?>
      <div class="jumbotron">
        <h2 style='margin-top:0px;padding-top:0px;'>Hasil : </h2>
